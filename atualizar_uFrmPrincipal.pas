...
begin
  ...
  lblAtualizacao.Caption:= 'Descompactando arquivo de atualização';
...
// 'Atualização',MB_OK+MB_ICONINFORMATION) = IDOK then AtualizarVersao;
// else Application.Terminate;
//ShowMessage(BoolToStr(msgAtualizacao));
Form1.Caption := Form1.Caption +' Versão: '+ exnf1.FileVersion ;
end;
...
//begin
//if Application.MessageBox('Esse aplicativo desatualizado. Aguarde um instante (Aprox. 3MB)',
// 'Atualização',MB_OK+MB_ICONINFORMATION) = IDOK then
  begin
